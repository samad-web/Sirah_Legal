          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mode === 'login' && (
              <div className="flex justify-end -mt-2">
                {forgotSent ? (
                  <span className="text-[11px] text-[#86efac]" style={{ fontFamily: 'DM Mono, monospace' }}>
                  ...
                  <button
                    ...
                    className="text-[11px] text-[rgba(201,168,76,0.6)] hover:text-[#C9A84C] transition-colors nav-hover-gold"
                    style={{ fontFamily: 'DM Mono, monospace' }}
                  >
